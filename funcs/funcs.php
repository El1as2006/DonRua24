...
function enviarEmail($email, $nombre, $asunto, $cuerpo){
    ...
    $mail->Host = "smtp.gmail.com";
    $mail->Port = 587;
    $mail->Username = "gptpluschat416@gmail.com";
    $mail->Password = "qbew aekb tffo pdac";


    // $mail->SetFrom('miemail@dominio.com', 'Sistema con PHP');
    // $mail->AddAddress($email, $nombre);
    $mail->SetFrom('gptpluschat416@gmail.com', 'DonRua');
    $mail->AddAddress($email, $nombre);
...
function isEmail($email)
    ...
    function generateTokenPass($user_id)
    {
        ...
        $stmt = $mysqli->prepare("UPDATE usuarios SET token = ?, WHERE id = ?");
