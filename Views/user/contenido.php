...
<body>
                    ...
                    <div class="">
                        <div class="mainmenu_width_tx  ">
                            <div class="solutech-main-menu one_page hidden-xs hidden-sm witr_h_h10"
                                ...
                                <div class="solutech_nav_area scroll_fixed postfix prefix">
                                    <div class="container">
                            ...
                            <div style="display: none; width: 1003.33px; height: 99.9653px; float: none;"></div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="home-2 mbm hidden-md hidden-lg  header_area main-menu-area">
        <div class="menu_area mobile-menu mean-container">
            ...
            <nav class="solutech_menu" style="display: none;">
                <ul class="sub-menu">
                    <li class="menu-item-has-children">
                        <a href="#">Home</a>
                        <ul class="sub-menu">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="solutech-single-blog solutech-lt">
                                <div class="solutech-blog-meta post_blog">
                                    <h2><a href="single-blog.html">Questions every business owner able to answer</a>
                                    </h2>
                                    <div class="solutech-blog-meta">
                                        <div class="solutech-blog-meta-left">
                                            <span><i class="fas fa-calendar-alt"></i>05 July, 2024</span>
                                ...
                                <div class="solutech-blog-thumb">
                                    <a href="single-blog.html"> <img
                                            src="../../Assets/template1/assets/images/solutech-blog-10.jpg" alt="image">
                                    </a>
                                </div>
                                <div class="em-blog-content-area">
                                    ...
                                    <div class="blog-inner">
                                        <div class="blog-content">
                                            <p>Our offices are located on the trad, unced. photo booth stumptown to
                                                banksy, elit small batch freegan… How to Attain Process Automation
                                                Satisfaction. Naturally, the appeal of Robot for its market potential
                                                cannot </p>
                                        </div>
                                    </div>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6  col-sm-12">
                        <div class="copy-right-text">
                            <p>Copyright © domingo savio all rights reserved.</p>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6  col-sm-12">
    ...
    <script src="../../Assets/template1/assets/js/theme.js"></script><a id="scrollUp" href="#top"
