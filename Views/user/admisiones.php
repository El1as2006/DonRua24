                ...
                <div class="col-lg-12">
                    <div class="witr_section_title">
                        <div class="witr_section_title_inner text-center">
                            ...
                            <p>Escriba la información del aspirante en los campos.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-8 col-md-12 col-sm-12">
                    <div class="apartment_area">
                        ...
                        <div class="witr_apartment_form">
                            <form action="admisiones.php" method="post" id="contact-form">
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <span><input type="text" name="name" placeholder="Nombre Completo"></span>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <span><input type="number" name="edad" placeholder="Edad"></span>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        <span><input type="text" name="nacionalidad" placeholder="Nacionalidad"></span>
                                    </div>
                                    <div class="form-group col-md-6 ">
                                        <span><input type="text" name="phone" placeholder="Teléfono de contacto"></span>
                                    </div>
                                    <div class="form-group col-md-6">
